...
error_reporting(0);
 ...
 if (!$conn) {
     ...
     $id = $_GET['id'];
     $row = mysqli_fetch_assoc(mysqli_query($conn,"select * from showdata where id='$id'"));
?>
...
<div class="container card card-body">
        ...
        <form action="update.php" method="post">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text"  value="<?= $row['add'] ?>"  class="form-control form-control-sm" id="colFormLabel" placeholder=" Enter your Address" name="txtadd">
                </div>
                ...
                <div class="col-sm-10">
                    <input type="password"  value="<?= $row['pass'] ?>"  class="form-control form-control-sm" id="colFormLabel" placeholder=" Enter your password" name="txtpass">
                </div>
                <br><br>
